      ...
      <div className='card d-inline-block m-4' style={{ width: "18rem" }}>
        <Link to='/ds/card1Ds' style={linkStyle}>
          ...
          <div className='card-body'>
            ...
            <p className='card-text text-secondary'>We all know about the kind of buzz surrounding data science right now, it is The tech career of this decade and thats saying a lot!</p>
          </div>
        </Link>
      </div>
      <div className='card d-inline-block m-4' style={{ width: "18rem" }}>
